// Purchases: transaction history. Raw Astryx components only, no wrapper components — same
// convention as farm/page.tsx. Reuses ledgerEntries where isActual is true (lib/mock-data.ts
// postedTransactions()) so this can never drift from the money tab's own ledger.
'use client';
